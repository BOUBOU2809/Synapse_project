...
use App\Repository\ResultatsSousTestTamiCRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: ResultatsSousTestTamiCRepository::class)]
class ResultatsSousTestTamiC
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    private ?SousTestTamiC $sous_tests = null;
    ...
    public function getSousTests(): ?SousTestTamiC
    {
        return $this->sous_tests;
    }

    public function setSousTests(?SousTestTamiC $sous_tests): static
    {
